...
/*                                                   +#+                      */
/*   Created: 2020/02/19 15:32:39 by qli            #+#    #+#                */
/*   Updated: 2020/02/19 16:37:18 by qli           ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_char_convert(t_input *input, t_print *print, int c)
{
	...
	if (input->flag == 0)
		ft_no_flag(input, print, &c);
	else if (input->minus_flag == 1)
		ft_minus_flag(input, print, &c);
	else if (input->zero_flag == 1)
		ft_zero_flag(input, print, &c);
	return (0);
}
